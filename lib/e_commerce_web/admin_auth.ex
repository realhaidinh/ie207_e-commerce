defmodule ECommerceWeb.AdminAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_e_commerce_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule ECommerceWeb.PageLive do
        ...
        on_mount {ECommerceWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ECommerceWeb.AdminAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/admin/dashboard/catalog/products"
end
