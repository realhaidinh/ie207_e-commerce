defmodule ECommerceWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_e_commerce_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule ECommerceWeb.PageLive do
        ...
        on_mount {ECommerceWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ECommerceWeb.UserAuth, :ensure_authenticated}] do
